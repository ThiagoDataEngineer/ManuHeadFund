...
function Invoke-OrchestratorCandidatesParallel {
    ...
    $script = {
        ...
        try {
            # Re-dot-source libs EXATAS que scan_master.ps1 carrega
            # 2026-06-01: CÓPIA EXATA para evitar dessincronização
            $libs = @(
                ...
                "lib_fundamental_quality.ps1",
                "lib_entry_score_boost.ps1",
