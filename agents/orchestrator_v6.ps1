...
# ─────────────────────────────────────────────────────────────────────────────
# NOTE: Dependencies are loaded in scan_master.ps1 BEFORE orchestrator_v6.ps1
# This prevents double-sourcing and ordering issues.
# Required functions: Invoke-MentorDebate, Update-Layer4Review, etc
# are already available from mentor_agent.ps1 and lib_layer4_tori_timestop.ps1
# ─────────────────────────────────────────────────────────────────────────────
